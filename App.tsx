...
function GymlogApp() {
  ...
  return (
    <AppShell
      ...
      statusBarStyleOverride={emptyWorkoutActive || readyTemplatesActive || exerciseDetailActive || exercisesListActive || profileListActive || premiumActive || planSettingsActive || exercisePreferencesActive || equipmentActive || progressActive || onboardingScreenActive ? 'dark' : welcomeActive ? 'dark' : undefined}
      statusBarBackgroundColor={emptyWorkoutActive || readyTemplatesActive || exerciseDetailActive || exercisesListActive || profileListActive || premiumActive || planSettingsActive || exercisePreferencesActive || equipmentActive || progressActive ? '#F7F3FF' : welcomeActive ? 'transparent' : undefined}
      statusBarTranslucent={welcomeActive}
      shellBackgroundColor={onboardingScreenActive ? '#F7F3FF' : emptyWorkoutActive || readyTemplatesActive || exerciseDetailActive || exercisesListActive || profileListActive || premiumActive || planSettingsActive || exercisePreferencesActive || equipmentActive || progressActive ? '#F7F3FF' : undefined}
      tabBar={
        showTabBar ? (
          <BottomTabBar
