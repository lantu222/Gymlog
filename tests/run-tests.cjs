...
const suites = [
  ...
  ...require('./features/workout/supersetSession.test.cjs'),
  ...
  ...require('./utils/sessionNotifications.test.cjs'),
  ...require('./components/primaryCTAButton.test.cjs'),
  ...require('./components/sessionAnalysisScreen.test.cjs'),
  ...
  ...require('./lib/programCatalogFilter.test.cjs'),
  ...require('./lib/strengthGoalPlan.test.cjs'),
  ...require('./lib/plainExerciseNames.test.cjs'),
  ...
  ...require('./lib/completedSessions.test.cjs'),
  ...
  ...require('./lib/analyticsRetention.test.cjs'),
  ...require('./lib/analyticsMoments.test.cjs'),
  ...require('./lib/analyticsRead.test.cjs'),
  ...require('./api/eventsEndpoint.test.cjs'),
  ...require('./scripts/analyticsReport.test.cjs'),
  ...require('./screens/analyticsTruth.test.cjs'),
  ...require('./lib/coachSuggestions.test.cjs'),
  ...require('./lib/aiCoachCostModel.test.cjs'),
  ...require('./lib/trainingCalendar.test.cjs'),
  ...
  ...require('./lib/supersetsSurviveSaves.test.cjs'),
  ...
  ...require('./lib/recoveryWeekAgreement.test.cjs'),
  ...
  ...require('./lib/appWrittenNamesTranslated.test.cjs'),
  ...require('./lib/numericDates.test.cjs'),
  ...
  ...require('./lib/coachKeyHealth.test.cjs'),
  ...
  ...require('./screens/sessionAdaptationWiring.test.cjs'),
  ...
  ...require('./screens/emptyWorkoutGuards.test.cjs'),
  ...
  ...require('./screens/searchRankingReachesTheList.test.cjs'),
  ...
  ...require('./screens/settingsSurfaces.test.cjs'),
  ...require('./lib/aiLogDeletion.test.cjs'),
  ...require('./lib/restAlertAnswer.test.cjs'),
  ...require('./lib/notificationAccessState.test.cjs'),
  ...require('./lib/reminderOptIn.test.cjs'),
  ...require('./lib/reminderSchedule.test.cjs'),
  ...
  ...require('./lib/programLineage.test.cjs'),
  ...require('./lib/programmeCopyLink.test.cjs'),
  ...
  ...require('./screens/completionCardSourceLink.test.cjs'),
  ...
  ...require('./lib/androidPermissions.test.cjs'),
