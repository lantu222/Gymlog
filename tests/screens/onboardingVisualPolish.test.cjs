...
module.exports = [
  {
    ...
    run() {
      ...
      // Plan-ready views animate on one shared card and gate on the account view.
      ...
      // CTA labels are sentence case in the light redesign.
      assert.match(onboardingSource, /\? 'Save plan & start'/);
      assert.match(onboardingSource, /: 'See day 1'/);
