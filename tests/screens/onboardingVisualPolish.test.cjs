...
module.exports = [
  {
    ...
    run() {
      ...
      assert.match(onboardingSource, /locationEquipmentTopPane:\s*\{[\s\S]*height: 222[\s\S]*paddingTop: 36/);
      ...
      assert.match(onboardingSource, /locationStepOneOptionsShift:\s*\{[\s\S]*translateY: -22/);
      ...
      assert.match(onboardingSource, /bodyweightTopPane:\s*\{[\s\S]*height: 206[\s\S]*paddingTop: 24/);
