...
module.exports = [
  {
    ...
    run() {
      ...
      assert.match(appSource, /shellBackgroundColor=\{onboardingScreenActive \? '#F7F3FF' : emptyWorkoutActive \|\| readyTemplatesActive \|\| exerciseDetailActive \|\| exercisesListActive \|\| profileListActive \? '#F7F3FF' : undefined\}/);
