                    ...
                    <View style={styles.coachCard}>
                      <View style={styles.coachCardHead}>
                        <Svg width={14} height={14} viewBox="0 0 24 24">
                          <Path d="M12 2l2.2 5.8L20 10l-5.8 2.2L12 18l-2.2-5.8L4 10l5.8-2.2z" fill={theme.purpleBright} />
                        </Svg>
                  ...
                  <View style={styles.activeExercisePanel}>
                    ...
                    >
                      <Svg width={17} height={17} viewBox="0 0 24 24" fill="none">
                        <Circle cx={12} cy={13} r={8} stroke={theme.purpleBright} strokeWidth={2} />
                        <Path d="M12 9v5l3 2M9 3h6" stroke={theme.purpleBright} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                      </Svg>
      ...
      {noteTarget ? (
        <InlineSheet title={t(language, 'logger.notes.title', { name: noteTarget.exerciseName })} closeLabel={t(language, 'logger.close')} onClose={() => setNoteSlotId(null)}>
          <TextInput
            ...
            selectionColor={theme.purpleBright}
          />
          <Pressable
            onPress={() => {
              if (!noteSlotId) {
