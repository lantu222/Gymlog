...
const EN = {
  ...
  'guided.pause': 'Pause',
  'guided.skip': 'Skip',
  'guided.setOfCount': 'SET {index} OF {count}',
  'guided.previousSet': 'Previous set ✓ {reps} × {kg} kg',
  'guided.do': 'DO',
  'guided.reps': 'REPS',
  'guided.weight': 'WEIGHT',
  'guided.back': '‹ Back',
  'guided.logSetReps': 'Log set — {reps} reps',
  'guided.logSetWeight': 'Log set — {reps} × {kg} kg',
  'guided.tapNumbers': 'Tap the numbers to adjust',
...
const FI: Record<I18nKey, string> = {
  ...
  'guided.previousSet': 'Edellinen sarja ✓ {reps} × {kg} kg',
  'guided.do': 'TEE',
  'guided.reps': 'TOISTOT',
  'guided.weight': 'PAINO',
  'guided.back': '‹ Takaisin',
  'guided.logSetReps': 'Kirjaa sarja — {reps} toistoa',
  'guided.logSetWeight': 'Kirjaa sarja — {reps} × {kg} kg',
  'guided.tapNumbers': 'Napauta numeroita säätääksesi',
