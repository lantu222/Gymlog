  ...
  // season programme has to be worth joining a season for.
  {
    ...
    sessions: [
      ...
      session({ id: 'season_summer_pull', name: 'Day 2: Strength and Tempo Run', orderIndex: 2, exercises: [
        ...
        ex({ id: 'season_summer_pull_swing', exerciseName: 'Kettlebell Swing', slotId: 'secondary_hinge_1', role: 'secondary', progressionPriority: 'medium', trackingMode: 'load_and_reps', sets: 4, repsMin: 12, repsMax: 18, restSecondsMin: 60, restSecondsMax: 90, substitutionGroup: 'explosive_power' }),
  ...
  // ─── SHRED: 3-day fat loss — full body + conditioning finishers ──────────
  {
    ...
    sessions: [
      session({ id: 'shred_day1', name: 'Day 1: Full Body + HIIT', orderIndex: 1, exercises: [
        ...
        ex({ id: 'shred_day1_kettlebell_swing', exerciseName: 'Kettlebell Swing', slotId: 'secondary_conditioning_1', role: 'secondary', progressionPriority: 'medium', trackingMode: 'load_and_reps', sets: 3, repsMin: 15, repsMax: 20, restSecondsMin: 30, restSecondsMax: 60, substitutionGroup: 'explosive_power' }),
      ...
      session({ id: 'shred_day2', name: 'Day 2: Full Body + Circuit', orderIndex: 2, exercises: [
        ...
        ex({ id: 'shred_day2_burpee', exerciseName: 'Burpee', slotId: 'finisher_conditioning_1', role: 'accessory', progressionPriority: 'low', trackingMode: 'bodyweight', sets: 4, repsMin: 8, repsMax: 12, restSecondsMin: 30, restSecondsMax: 60, substitutionGroup: 'conditioning_circuit' }),
      ] }),
      session({ id: 'shred_day3', name: 'Day 3: Full Body + Intervals', orderIndex: 3, exercises: [
        ...
        ex({ id: 'shred_day3_farmers_walk', exerciseName: "Farmer's Walk", slotId: 'secondary_conditioning_1', role: 'secondary', progressionPriority: 'medium', trackingMode: 'load_and_reps', sets: 3, repsMin: 30, repsMax: 40, restSecondsMin: 60, restSecondsMax: 90, substitutionGroup: 'conditioning_circuit' }),
  ...
  },
  {
    ...
    sessions: [
      session({ id: 'fit_elite_upper_a', name: 'Day 1: Upper Power', orderIndex: 1, exercises: [
        ...
        ex({ id: 'fit_elite_upper_a_kettlebell_swing', exerciseName: 'Kettlebell Swing', slotId: 'finisher_conditioning_1', role: 'accessory', progressionPriority: 'low', trackingMode: 'load_and_reps', sets: 3, repsMin: 15, repsMax: 20, restSecondsMin: 30, restSecondsMax: 60, substitutionGroup: 'explosive_power' }),
      ] }),
      ...
      session({ id: 'fit_elite_upper_b', name: 'Day 3: Upper Volume', orderIndex: 3, exercises: [
        ...
        ex({ id: 'fit_elite_upper_b_burpee', exerciseName: 'Burpee', slotId: 'finisher_conditioning_1', role: 'accessory', progressionPriority: 'low', trackingMode: 'bodyweight', sets: 4, repsMin: 8, repsMax: 12, restSecondsMin: 30, restSecondsMax: 60, substitutionGroup: 'conditioning_circuit' }),
      ] }),
  ...
  },
  {
    ...
    sessions: [
      session({ id: 'shred_elite_day1', name: 'Day 1: Squat + Intervals', orderIndex: 1, exercises: [
        ...
        ex({ id: 'shred_elite_day1_kettlebell_swing', exerciseName: 'Kettlebell Swing', slotId: 'secondary_conditioning_1', role: 'secondary', progressionPriority: 'medium', trackingMode: 'load_and_reps', sets: 3, repsMin: 15, repsMax: 20, restSecondsMin: 30, restSecondsMax: 60, substitutionGroup: 'explosive_power' }),
      ...
      session({ id: 'shred_elite_day2', name: 'Day 2: Press + Circuit', orderIndex: 2, exercises: [
        ...
        ex({ id: 'shred_elite_day2_burpee', exerciseName: 'Burpee', slotId: 'finisher_conditioning_1', role: 'accessory', progressionPriority: 'low', trackingMode: 'bodyweight', sets: 5, repsMin: 8, repsMax: 12, restSecondsMin: 30, restSecondsMax: 60, substitutionGroup: 'conditioning_circuit' }),
      ] }),
      ...
      session({ id: 'shred_elite_day5', name: 'Day 5: Engine + Reset', orderIndex: 5, exercises: [
        ex({ id: 'shred_elite_day5_kettlebell_swing', exerciseName: 'Kettlebell Swing', slotId: 'primary_conditioning_1', role: 'primary', progressionPriority: 'high', trackingMode: 'load_and_reps', sets: 4, repsMin: 15, repsMax: 20, restSecondsMin: 45, restSecondsMax: 75, substitutionGroup: 'explosive_power' }),
